...
// //example: http://localhost:4002/api/method=get&appkey=436etaq52e57a3cd028ab56b&seckey=sec-mj12Slu12w1Xs1er8ZzmGZqw5qrpFmqw25jHULr13eUZCswA/cross/87654321/start=2017-12-19 13:31:4&2017-12-20 13:31:4/1
// FlowOp.prototype.findByCrossByPeriod = function (id, start, end, page,callback) {
//     FlowModel.find(
//         {
//             'CrossTrafficData.CrossID': id,
//             'CrossTrafficData.DateTime': {$gt: start, $lte: end}
...
//         (err, data_id_p) => {
//
//             callback(err, data_id_p);
//         }
//     ).skip((page - 1) * 10).limit(10);
// };
//
//
// FlowOp.prototype.findByCrossByPeriodTotalPages = function (id, start, end,callback) {
//     FlowModel.count(
//         {
//             'CrossTrafficData.CrossID': id,
//             'CrossTrafficData.DateTime': { $gt: start, $lte: end }
...
const CarFlow = mongoose.model('CarFlow', FlowSchema);

module.exports = CarFlow;
